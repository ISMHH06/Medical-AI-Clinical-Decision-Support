...
| E06 | 2026-09-15 | 6 | Clinical MLP (29 features, 64-32-5) | clinical-only baseline: age, BMI (median-imputed + missingness flag), sex/race/ethnicity/insurance_type (one-hot), no images | 0.5277 | 0.3208 | Best: Cardiomegaly (0.5737), Worst: Atelectasis (0.4909). |
